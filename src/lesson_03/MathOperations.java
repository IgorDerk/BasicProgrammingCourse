...
public class MathOperations {
    public static void main(String[] args) {
        ...
        // strg + D - скопировать строку
        // alt + shift - перемещать строку
        int var1 = 20;
        int var2 = 7;
        ...
        // 20 + 7 -> 27 -> result
        result = var1 + var2;
        // Резулятат вычислений выражения в правой части (от знака =) присваевается в переменную в левой части
        ...
        System.out.println("16 / 5: " + 16 / 5); // 3 целых + 1  в остатках

        // % остаток от деления %
        System.out.println("Целочисленное деление 4 / 2: " + (4 / 2)); // 2
        System.out.println("Остаток от деления, делние  4 % 2: " + (4 % 2)); // 0
